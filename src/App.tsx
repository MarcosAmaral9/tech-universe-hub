...
const DiscordBrasilSuspensao2026 = lazy(() => import("./pages/posts/DiscordBrasilSuspensao2026"));
...
const GhostOfTsushimaGuia            = lazy(() => import("./pages/posts/GhostOfTsushimaGuia"));
      ...
      <ThemeProvider>
        ...
        <BrowserRouter>
          ...
          <Routes>
                ...
                {/* ── 28 Mai 2026 IA e Otaku ── */}
                <Route path="/post/dola-ai-app-assistente-2026" element={<Suspense fallback={<div />}><DolaAI2026 /></Suspense>} />
                ...
                <Route path="/post/ghost-of-tsushima-guia-completo" element={<Suspense fallback={<div />}><GhostOfTsushimaGuia /></Suspense>} />
