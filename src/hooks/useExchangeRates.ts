/**
 * useExchangeRates — agora é um thin wrapper sobre useMarketData.
 * Mantém a mesma interface pública para não quebrar CurrencyWidget
 * e PreciousMetalsWidget que dependem dele.
 */
