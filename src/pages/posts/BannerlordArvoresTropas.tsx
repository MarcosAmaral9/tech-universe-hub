...
const trees: Array<{
  ...
  {
    name: "Empire (Norte / Sul / Oeste)",
    inspiration: "Bizâncio fragmentado",
    color: "bg-indigo-500/15 text-indigo-300 border-indigo-500/30",
    accent: "text-indigo-300",
    bg: "from-indigo-500/10",
    border: "border-indigo-500/30",
    highlight: "Cataphract & Legionary — combinação clássica de cavalaria de choque pesada + linha disciplinada.",
    rows: [
