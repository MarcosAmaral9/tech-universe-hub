    ...
    <article className="container py-8 max-w-4xl mx-auto">
      ...
      <div className="relative rounded-2xl overflow-hidden mb-8 aspect-video">
        <img fetchpriority="high"
          fetchPriority="high" src={heroImg} alt="Prompt engineering em 2026 — guia definitivo para escrever prompts que funcionam com ChatGPT, Claude e Gemini" loading="eager" decoding="async" className="w-full h-full object-cover" />
      </div>
