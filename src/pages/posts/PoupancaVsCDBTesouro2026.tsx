...
<h2 className="flex items-center gap-3 text-2xl font-bold mt-10 mb-6">
      ...
      <section className="my-10">
        <div className="bg-card border border-primary/30 rounded-2xl p-6 mb-6">
          ...
          <p className="text-muted-foreground leading-relaxed mb-3">Comparativo válido em maio/2026 com Selic em queda gradual segundo Atas do Copom (Banco Central): poupança rende 70% da Selic + TR quando Selic ≤ 8,5% a.a., ou 0,5% a.m. + TR quando Selic acima de 8,5% a.a. CDB pós-fixado de bancos médios paga 100-120% do CDI; Tesouro Selic 2030 oferece rentabilidade próxima a 100% da Selic líquida de custódia (0% até R$ 10 mil/ano desde 2024).</p>
          <p className="text-muted-foreground leading-relaxed mb-3">Tributação fundamental: poupança é isenta de IR (rendimento baixo); CDB e Tesouro seguem tabela regressiva (22,5% até 180 dias → 15% acima de 720 dias). Garantia FGC de até R$ 250 mil por CPF por instituição cobre poupança e CDB; Tesouro é garantido pelo governo federal.</p>
          <p className="text-muted-foreground leading-relaxed mb-3">Minha análise: em qualquer cenário de Selic acima de 8% a.a., poupança perde para CDB de banco médio com FGC. Para reserva de emergência, Tesouro Selic é a opção mais líquida (D+0 nas principais corretoras) e segura. CDB faz sentido para prazo médio (1-3 anos) buscando 110%+ do CDI. Nunca deixe dinheiro na poupança 'por hábito' — a perda real ao longo de 10 anos é significativa.</p>
        </div>

        <div className="bg-muted/30 border border-border rounded-2xl p-6">
          <h3 className="font-display text-xl font-bold mb-4">Fontes consultadas</h3>
          <ul className="space-y-2 text-sm">
            <li><a href="https://www.bcb.gov.br/controleinflacao/historicotaxasjuros" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline break-words">Banco Central — Histórico Selic ↗</a></li>
            <li><a href="https://www.tesourodireto.com.br/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline break-words">Tesouro Direto — Como investir ↗</a></li>
            <li><a href="https://www.fgc.org.br/" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline break-words">FGC — Fundo Garantidor de Créditos ↗</a></li>
            <li><a href="https://www.gov.br/receitafederal/pt-br" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline break-words">Receita Federal — IR Renda Fixa ↗</a></li>
