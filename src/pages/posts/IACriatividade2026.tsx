  ...
  return (
    <article className="container py-8 max-w-4xl mx-auto">
      ...
      <EditorialTake category="ia" title="Análise do Marcos: quem vai pagar pelo treinamento com obras brasileiras sem licença?">
        ...
        <p>
          Uma distinção importante que costuma se perder no debate: ferramentas de IA criativa bem usadas não substituem a criatividade humana — elas eliminam o atrito entre a ideia e a execução. Um músico que leva 3 horas para produzir uma faixa instrumental de fundo que vai usar em um vídeo institucional pode agora levar 20 minutos com Suno ou Udio. O tempo economizado não vai para o modelo — vai para o trabalho criativo que o músico realmente quer fazer. O mesmo vale para design: ilustradores que usam Midjourney ou Firefly para gerar referências visuais rápidas produzem mais trabalho original, não menos, porque gastam menos tempo nas partes operacionais do processo criativo e mais tempo nas decisões estéticas e conceituais que definem a identidade do trabalho.
        </p>
        <p>
