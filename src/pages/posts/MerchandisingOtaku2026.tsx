  ...
  return (
    <article className="container py-8 max-w-4xl mx-auto">
      ...
      <div className="relative rounded-2xl overflow-hidden mb-8 aspect-video">
        <img fetchpriority="high" src={heroImg} alt="Merchandising Otaku 2026" className="w-full h-full object-cover" />
      </div>
      ...
      <CommentSection postId="merchandising-otaku-colecionar-2026" />
    </article>
  );
};
