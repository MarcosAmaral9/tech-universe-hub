...
const AnimeVerao2026DiasSemana = () => {
  ...
  const schedule = {
    ...
    "Sexta-feira": [
      { titulo: "Mushoku Tensei III: Isekai Ittara Honki Dasu", horario: "12h01", plataforma: "Crunchyroll", nota: "⭐⭐⭐⭐⭐", destaque: true, desc: "14 episódios pelo Studio Bind. O isekai mais bem escrito em termos de desenvolvimento de personagem continua com o Arco da Migração de Rudeus. Estreia 21 de julho." },
  ...
  return (
    <article className="container py-8 max-w-4xl mx-auto">
      ...
      <div className="prose prose-lg dark:prose-invert max-w-none mt-10">
        ...
        <p>
          O sábado ganha ainda mais peso a partir de 25 de julho, quando Bleach: TYBW — Kashin-tan (a parte final definitiva da franquia Bleach) entra na grade às 11h30 BRT. Antes disso, o sábado já é um dos dias mais ricos: Mushoku Tensei III na semana de estreia (21 de julho é terça), Gaikotsu Kishi-sama S2, Tenmaku no Jaadugar (Science SARU), Magilumiere S2 e Nanoha EXCEEDS. Para o espectador que prefere concentrar o consumo de anime num único dia da semana, sábado é a escolha óbvia nesta temporada.
        </p>
